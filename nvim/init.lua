...
--
--- NOTE: 多行数字增加 <Ctrl-a> 和数字减少 <Ctrl-x>
--    - Normal, <C-a> 光标下数字+1, 6<C-a> 光标下数字+6; <C-x> 光标下数字-1, 6<C-x> 光标下数字-6...
--    - visual-block 选择多行数字, <C-a>, 每行数字+1, 3<C-a> 每行数字+3, g<C-a> (visual)第一行+1, 第二行+2, 第n行+n...
--    - visual-block 选择多行数字, <C-x>, 每行数字-1, 3<C-x> 每行数字-3, g<C-x> (visual)第一行-1, 第二行-2, 第n行-n...
-- -- }}}
