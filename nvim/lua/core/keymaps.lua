...
local keymaps = {
  ...
  {'n', '<leader>"', 'viw<C-c>`>a"<C-c>`<lt>i"<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', "<leader>'", "viw<C-c>`>a'<C-c>`<lt>i'<C-c>`><right><right>", opt, 'which_key_ignore'},
  {'n', '<leader>`', 'viw<C-c>`>a`<C-c>`<lt>i`<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', '<leader>*', 'viw<C-c>`>a*<C-c>`<lt>i*<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', '<leader>_', 'viw<C-c>`>a_<C-c>`<lt>i_<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', '<leader>$', 'viw<C-c>`>a$<C-c>`<lt>i$<C-c>`><right><right>', opt, 'which_key_ignore'},

  {'n', '<leader>{',    'viw<C-c>`>a}<C-c>`<lt>i{<C-c>`<lt>',            opt, 'which_key_ignore'},
  {'n', '<leader>}',    'viw<C-c>`>a}<C-c>`<lt>i{<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', '<leader>[',    'viw<C-c>`>a]<C-c>`<lt>i[<C-c>`<lt>',            opt, 'which_key_ignore'},
  {'n', '<leader>]',    'viw<C-c>`>a]<C-c>`<lt>i[<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', '<leader>(',    'viw<C-c>`>a)<C-c>`<lt>i(<C-c>`<lt>',            opt, 'which_key_ignore'},
  {'n', '<leader>)',    'viw<C-c>`>a)<C-c>`<lt>i(<C-c>`><right><right>', opt, 'which_key_ignore'},
  {'n', '<leader><lt>', 'viw<C-c>`>a><C-c>`<lt>i<lt><C-c>`<lt>',         opt, 'which_key_ignore'},
  {'n', '<leader>>',    'viw<C-c>`>a><C-c>`<lt>i<lt><C-c>`><right><right>', opt, 'which_key_ignore'},

  {'x', '<leader>"', '<C-c>`>a"<C-c>`<lt>i"<C-c>v`><right><right>', opt, 'which_key_ignore'},
  {'x', "<leader>'", "<C-c>`>a'<C-c>`<lt>i'<C-c>v`><right><right>", opt, 'which_key_ignore'},
  {'x', '<leader>`', '<C-c>`>a`<C-c>`<lt>i`<C-c>v`><right><right>', opt, 'which_key_ignore'},
  {'x', '<leader>*', '<C-c>`>a*<C-c>`<lt>i*<C-c>v`><right><right>', opt, 'which_key_ignore'},
  {'x', '<leader>_', '<C-c>`>a_<C-c>`<lt>i_<C-c>v`><right><right>', opt, 'which_key_ignore'},
  {'x', '<leader>$', '<C-c>`>a$<C-c>`<lt>i$<C-c>v`><right><right>', opt, 'which_key_ignore'},

  {'x', '<leader>{',    '<C-c>`>a}<C-c>`<lt>i{<C-c>`><right><right>v`<lt>', opt, 'which_key_ignore'},
  {'x', '<leader>}',    '<C-c>`>a}<C-c>`<lt>i{<C-c>v`><right><right>',      opt, 'which_key_ignore'},
  {'x', '<leader>[',    '<C-c>`>a]<C-c>`<lt>i[<C-c>`><right><right>v`<lt>', opt, 'which_key_ignore'},
  {'x', '<leader>]',    '<C-c>`>a]<C-c>`<lt>i[<C-c>v`><right><right>',      opt, 'which_key_ignore'},
  {'x', '<leader>(',    '<C-c>`>a)<C-c>`<lt>i(<C-c>`><right><right>v`<lt>', opt, 'which_key_ignore'},
  {'x', '<leader>)',    '<C-c>`>a)<C-c>`<lt>i(<C-c>v`><right><right>',      opt, 'which_key_ignore'},
  {'x', '<leader><lt>', '<C-c>`>a><C-c>`<lt>i<lt><C-c>`><right><right>v`<lt>', opt, 'which_key_ignore'},
  {'x', '<leader>>',    '<C-c>`>a><C-c>`<lt>i<lt><C-c>v`><right><right>',   opt, 'which_key_ignore'},
