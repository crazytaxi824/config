...
M.textDocument_keymaps = function(bufnr)
  ...
  local textdoc_keymaps = {
    ...
    {"n", "<F4>", function() vim.lsp.buf.hover() end, opts, "Fn 4: LSP: Hover"},
    {"i", "<F4>", function() vim.lsp.buf.hover() end, opts, "Fn 4: LSP: Hover"},
...
M.diagnostic_keymaps = function(bufnr)
  ...
  local diag_keymaps = {
    ...
    {"n", "<F8>",   function() vim.diagnostic.goto_next() end, opts, "Fn 8: diagnostic: goto Next Error"},
    {"n", "<D-F8>", function() vim.diagnostic.goto_prev() end, opts, "Fn 8: diagnostic: goto Prev Error"},
