local hl = {
  ...
  diagnostic_error = vim.tbl_extend('force', Highlights.DiagnosticError, { bold=true }),
  diagnostic_warn  = vim.tbl_extend('force', Highlights.DiagnosticWarn,  { bold=true }),
  diagnostic_info  = vim.tbl_extend('force', Highlights.DiagnosticInfo,  { bold=true }),
  diagnostic_hint  = vim.tbl_extend('force', Highlights.DiagnosticHint,  { bold=true }),
}
