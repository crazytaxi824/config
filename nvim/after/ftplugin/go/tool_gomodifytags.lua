...
vim.api.nvim_buf_create_user_command(
  ...
  function(params)
    ...
    require("user.ftplugin_deps.go").tag.add(params.fargs, go_add_tags_cmd, offset)
  end,
  {nargs = "+", bang = true}
)
...
vim.api.nvim_buf_create_user_command(
  ...
  function(params)
    ...
    require("user.ftplugin_deps.go").tag.add(params.fargs, go_add_tags_all_struct_cmd)
  end,
  {nargs = "+", bang = true}
)
...
vim.api.nvim_buf_create_user_command(
  ...
  function(params)
    ...
    require("user.ftplugin_deps.go").tag.remove(params.fargs, go_remove_tags_cmd, offset)
  end,
  {bang = true, nargs = "*"}
)
...
vim.api.nvim_buf_create_user_command(
  ...
  function(params)
    ...
    require("user.ftplugin_deps.go").tag.remove(params.fargs, go_remove_tags_all_struct_cmd)
  end,
  {bang = true, nargs = "*"}
)
...
vim.api.nvim_buf_create_user_command(
  ...
  function(params)
    ...
    require("user.ftplugin_deps.go").tag.remove_opts(params.fargs, go_remove_tag_opts_cmd, offset)
  end,
  {bang = true, nargs = "*"}
)
...
vim.api.nvim_buf_create_user_command(
  ...
  function(params)
    ...
    require("user.ftplugin_deps.go").tag.remove_opts(params.fargs, go_remove_tag_opts_all_struct_cmd)
  end,
  {bang = true, nargs = "*"}
)
