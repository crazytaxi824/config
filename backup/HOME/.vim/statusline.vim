...
def g:CheckMiTs(): string
	...
	# bufvar_tick == b:changedtick   buffer not changed
	if bufnr() != curr_bufnr || mode() != 'n' ||  getbufvar(bufnr(), bufvar_tick, 0) == b:changedtick
	...
	# cache changedtick
	setbufvar(bufnr(), bufvar_tick, b:changedtick)
